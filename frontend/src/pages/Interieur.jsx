...
// ===== IMAGES =====
import siegeImg from "../assets/volant.jpg";
import tableauImg from "../assets/bras.jpg";
import volantImg from "../assets/volant.jpg";
import carrosserieImg from "../assets/moteur.jpg";

// ===== DATA INITIAL =====
const dataInitial = [
  { id: 1, nom: "Siège conducteur cuir", image: siegeImg, prix: "850 000 Ar", type: "Siège", sousType: "Cuir", etat: "Neuf", contact: "034 00 000 00" },
  { id: 2, nom: "Siège tissu", image: siegeImg, prix: "450 000 Ar", type: "Siège", sousType: "Tissu", etat: "Neuf", contact: "034 00 000 00" },
  { id: 3, nom: "Tableau de bord complet", image: tableauImg, prix: "1 200 000 Ar", type: "Tableau", sousType: "Complet", etat: "Neuf", contact: "034 00 000 00" },
  { id: 4, nom: "Compteur vitesse", image: tableauImg, prix: "300 000 Ar", type: "Tableau", sousType: "Compteur", etat: "Neuf", contact: "034 00 000 00" },
  { id: 5, nom: "Volant multifonction", image: volantImg, prix: "280 000 Ar", type: "Volant", sousType: "Multifonction", etat: "Neuf", contact: "034 00 000 00" },
  { id: 6, nom: "Volant chauffant", image: volantImg, prix: "350 000 Ar", type: "Volant", sousType: "Chauffant", etat: "Neuf", contact: "034 00 000 00" },
  { id: 7, nom: "Pare-chocs avant", image: carrosserieImg, prix: "400 000 Ar", type: "Carrosserie", sousType: "Avant", etat: "Neuf", contact: "034 00 000 00" },
  { id: 8, nom: "Pare-chocs arrière", image: carrosserieImg, prix: "380 000 Ar", type: "Carrosserie", sousType: "Arrière", etat: "Neuf", contact: "034 00 000 00" },
  { id: 9, nom: "Console centrale", image: tableauImg, prix: "200 000 Ar", type: "Console", sousType: "Plastique", etat: "Neuf", contact: "034 00 000 00" },
  { id: 10, nom: "Poignée interieur", image: siegeImg, prix: "35 000 Ar", type: "Poignée", sousType: "Porte", etat: "Neuf", contact: "034 00 000 00" },
];

// ===== TYPES =====
const categories = ["Siège", "Tableau", "Volant", "Carrosserie"];

// ===== SOUS-CATEGORIES =====
const sousCategories = {
  Siège: ["Tous", "Cuir", "Tissu"],
  Tableau: ["Tous", "Complet", "Compteur"],
  Volant: ["Tous", "Multifonction", "Chauffant"],
  Carrosserie: ["Tous", "Avant", "Arrière"],
};
...
const [pieces, setPieces] = useState(dataInitial);
  ...
  const [newPart, setNewPart] = useState({
    ...
    prix: "",
    type: "Siège",
    sousType: "Cuir", etat: "Neuf", contact: ""
  });
  ...
  const handleAdd = async () => {
    ...
    try {
      ...
      const res = await fetch("/api/products", {
        ...
        body: JSON.stringify({
          ...
          categoryName: "Intérieur et carrosserie",
    ...
    setShowForm(false);
    setNewPart({ nom: "", pseudo: "", prix: "", type: "Siège", sousType: "Cuir", etat: "Neuf", contact: "034 00 000 00" });
  };
  ...
  return (
    <>
      ...
      <div className="container">
        <h2 className="title"><i className="fa-solid fa-chair"></i> Interieur</h2>
