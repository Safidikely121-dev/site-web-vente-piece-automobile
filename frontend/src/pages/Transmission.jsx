...
// ===== IMAGES =====
import boiteImg from "../assets/courroi.jpg";
import embrayageImg from "../assets/volant.jpg";
import cardanImg from "../assets/bras.jpg";
import differentielImg from "../assets/cremaillere.jpg";

// ===== DATA INITIAL =====
const dataInitial = [
  { id: 1, nom: "Boîte manuelle 5 vitesses", image: boiteImg, prix: "1 200 000 Ar", type: "Boite", sousType: "Manuelle", etat: "Neuf", contact: "034 00 000 00" },
  { id: 2, nom: "Plateau embrayage", image: embrayageImg, prix: "220 000 Ar", type: "Embrayage", sousType: "Plateau", etat: "Neuf", contact: "034 00 000 00" },
  { id: 3, nom: "Cardan avant", image: cardanImg, prix: "280 000 Ar", type: "Cardan", sousType: "Avant", etat: "Neuf", contact: "034 00 000 00" },
  { id: 4, nom: "Cardan arrière", image: cardanImg, prix: "260 000 Ar", type: "Cardan", sousType: "Arrière", etat: "Neuf", contact: "034 00 000 00" },
  { id: 5, nom: "Différentiel avant", image: differentielImg, prix: "950 000 Ar", type: "Différentiel", sousType: "Avant", etat: "Neuf", contact: "034 00 000 00" },
  { id: 6, nom: "Différentiel arrière", image: differentielImg, prix: "1 050 000 Ar", type: "Différentiel", sousType: "Arrière", etat: "Neuf", contact: "034 00 000 00" },
  { id: 7, nom: "Courroie auxiliaire", image: boiteImg, prix: "80 000 Ar", type: "Courroie", sousType: "Auxiliaire", etat: "Neuf", contact: "034 00 000 00" },
  { id: 8, nom: "Butée embrayage", image: embrayageImg, prix: "65 000 Ar", type: "Embrayage", sousType: "Butée", etat: "Neuf", contact: "034 00 000 00" },
  { id: 9, nom: "Arbre de transmission", image: cardanImg, prix: "450 000 Ar", type: "Arbre", sousType: "Transmission", etat: "Neuf", contact: "034 00 000 00" },
  { id: 10, nom: "Joint de boîte", image: boiteImg, prix: "25 000 Ar", type: "Joint", sousType: "Boîte", etat: "Neuf", contact: "034 00 000 00" },
  { id: 11, nom: "Disque d'embrayage", image: embrayageImg, prix: "180 000 Ar", type: "Embrayage", sousType: "Disque", etat: "Neuf", contact: "034 00 000 00" },
  { id: 12, nom: "Liquide de transmission", image: differentielImg, prix: "35 000 Ar", type: "Liquide", sousType: "Transmission", etat: "Neuf", contact: "034 00 000 00" },
];

// ===== TYPES =====
const categories = ["Boite", "Embrayage", "Cardan", "Différentiel", "Courroie", "Liquide"];

// ===== SOUS-CATEGORIES =====
const sousCategories = {
  Boite: ["Tous", "Manuelle", "Automatique"],
  Embrayage: ["Tous", "Disque", "Plateau", "Butée"],
  Cardan: ["Tous", "Avant", "Arrière"],
  Différentiel: ["Tous", "Avant", "Arrière"],
  Courroie: ["Tous", "Auxiliaire"],
  Liquide: ["Tous", "Transmission"],
};
...
const [pieces, setPieces] = useState(dataInitial);
  ...
  const [newPart, setNewPart] = useState({
    ...
    prix: "",
    type: "Boite",
    sousType: "Manuelle", etat: "Neuf", contact: ""
  });
  ...
  const handleAdd = async () => {
    ...
    try {
      ...
      const res = await fetch("/api/products", {
        ...
        body: JSON.stringify({
          ...
          categoryName: "Système de transmission",
    ...
    setShowForm(false);
    setNewPart({ nom: "", pseudo: "", prix: "", type: "Boite", sousType: "Manuelle", etat: "Neuf", contact: "034 00 000 00" });
  };
  ...
  return (
    <>
      ...
      <div className="container">
        <h2 className="title"><i className="fa-solid fa-gear"></i> Transmission</h2>
